...
initial begin
    ...
    for (int i=0;i<2**(5+2);i++) begin
        ...
        parallel_in   = test_quantity[5+1:2];
        ...
        if (!rst_n) begin
            ...
            if (ser) begin
                ...
                test_result[4] = test_result[4] ^ test_result[0]; // [4] = [3]^[5] but both inputs were just shifted up by one
            end
            else begin
